...
body{
 ...
 <body>
 <div class="a">
 	<b><a href="input.php">TAMBAH DATA</a></b> || <b><a href="../ruangan/daftar.php">LAYANAN RUANGAN</a></b> || <b><a href="../gizi/daftar.php">LAYANAN GIZI</a></b>
 	<hr>
 </div>
 <center>
 <table border="1" cellspacing="0" cellpadding="10" width="100%"> 
 	...
 	<tr>
 		...
 		<td><?php echo $i;; ?></td>
 		<td><a href="../hapus.php?no=<?php echo $row['noidpasien']; ?>" onclick="return confirm('yakin ingin menghapus..?')">hapus</a> <=> <a href="edit.php?no=<?php echo $row['noidpasien'];  ?> ">edit</a></td>
