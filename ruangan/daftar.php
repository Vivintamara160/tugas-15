...
body{
 ...
 <body>
 <div class="a">
 	<b><a href="input.php">TAMBAH DATA</a></b> || <b><a href="../pasien/daftar.php">DAFTAR PASIEN</a></b> || <b><a href="../gizi/daftar.php">LAYANAN GIZI</a></b>
 	<hr>
 </div>
 <center>
 <table border="1" cellspacing="0" cellpadding="10" width="100%"> 
 	...
 	<tr>
 		...
 		<td><?php echo $i;; ?></td>
 		<td><a href="../hapus.php?no1=<?php echo $row['norm']; ?>" onclick="return confirm('yakin ingin menghapus..?')">hapus</a> <=> <a href="edit.php?no1=<?php echo $row['norm'];  ?> ">edit</a></td>
